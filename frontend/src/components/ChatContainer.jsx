...
const renderTextWithLinks = (text) => {
  ...
  return parts.map((part, i) => {
    if (part.match(urlRegex)) {
      return (
        <a key={i} href={part} target="_blank" rel="noopener noreferrer" className="underline text-blue-400 hover:text-blue-300 hover:opacity-80 transition-all font-semibold">
          {part}
        </a>
      );
    }
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((message) => (
          ...
          >
            ...
            <div className={`chat-bubble flex flex-col ${message.isSystem ? 'bg-error text-error-content font-bold' : ''}`}>
              {message.image && (
                <img
                  src={message.image}
                  alt="Attachment"
